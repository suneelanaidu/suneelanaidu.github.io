...
my_list = ['pam','r','o','g','r','a','m']

if 'pam' in my_list:
    print("yes pams here")

# includes element at index 2, 3, 4
# includes element at index 2 & excludes element at index 5
print(my_list[2:5])
...
print(my_list[5:])
#Lists
listn = [10, 11, 12, 13, 14, 15]

print([ele for ele in reversed(listn)])

print(listn.index(13))
...
# to listnames = [person['name'] for person in json_dict]
print("Names of people to list: " + str(names))
