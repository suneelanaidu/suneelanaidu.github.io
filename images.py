...
#def image_data(path="C:/Users/snaidu/IdeaProjects/flask_portfolio/static/Assets/", img_list=None):  # path of static images is defaulted

# color_data prepares a series of images for data analysis
def image_data(path="C:/Users/snaidu/IdeaProjects/flask_portfolio/static/Assets/", img_list=None):  # path of static images is defaulted
    if img_list is None:  # color_dict is defined with defaults
        img_list = [
            {'source': "internet", 'label': "Bulb On", 'file': "lassen-volcano-256.jpg"},
        ]
    ...
    for img_dict in img_list:
        ...
        d1.text((1, 5), "HELLO WORLD!!!", fill=(0, 0, 0))
        #MRS NAIDU
...
if __name__ == "__main__":
    ...
    img_test = [
        {'source': "iconsdb.com", 'label': "Blue square", 'file': "bulb_off.png"},
    ]
